...
@ManagedBean
@ViewScoped
public class ClaseCalendario implements Serializable {
    ...
    public void init() {
       ...
       // eventModel.addEvent(new DefaultScheduleEvent(fiesta.getTitulo(), fiesta.getFechaFestivo(), fiesta.getFechaFestivo()));
